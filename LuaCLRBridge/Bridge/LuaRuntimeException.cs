...
namespace LuaCLRBridge
{
    ...
    /// <summary>
    /// Represents a Lua runtime-error message.
    /// </summary>
    [Serializable]
    public class LuaRuntimeException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LuaRuntimeException"/> class with a specified
        /// error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LuaRuntimeException"/> class with serialized data.
        /// </summary>
